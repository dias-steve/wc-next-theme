...
export const cartTypes = {
    SET_PRODUCT_LIST: 'SET_PRODUCT_LIST_CART',
    SET_TOTAL_QUANTITY:'SET_TOTAL_QUANTITY_CART',
    SET_TOTAL_AMOUNT:'SET_TOTAL_AMOUNT_CART',
    ADD_PRODUCT_TO_CART: 'ADD_PRODUCT_TO_CART',
    REMOVE_PRODUCT_TO_CART: 'REMOVE_PRODUCT_CART'
}
